...
/**
 * Swedbank - Financial Services
 * DUMMY DATA - Replace with actual deal information when available
 * Status: STALLED
 */

const swedbank: Deal = {
  id: 'deal-swedbank-001',
  company: 'Swedbank',
  dealSizeMRR: 5710,
  dealSizeAnnual: 68530,
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-swedbank-001/view',
  createdAt: '2025-06-14T05:12:42Z',
