...
/**
 * Office of the Director of National Intelligence - Government
 * DUMMY DATA - Replace with actual deal information when available
 * Status: STALLED
 */

const officeOfTheDirectorOfNationalIntelligence: Deal = {
  id: 'deal-office-of-the-direct-001',
  company: 'Office of the Director of National Intelligence',
  dealSizeMRR: 5000,
  dealSizeAnnual: 60000,
  industry: 'Government',
  ...
  activityLog: [
    {
      id: 'activity-office-of-the-d-001',
      date: '2025-10-29',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-office-of-the-direct-001/view',
  createdAt: '2025-03-04T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default officeOfTheDirectorOfNationalIntelligence;
