...
/**
 * Southern California Edison (SCE) - Energy & Utilities
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const southernCaliforniaEdisonSce: Deal = {
  id: 'deal-southern-california--001',
  company: 'Southern California Edison (SCE)',
  dealSizeMRR: 2400,
  dealSizeAnnual: 28800,
  industry: 'Energy',
  ...
  activityLog: [
    {
      id: 'activity-southern-califo-001',
      date: '2025-10-24',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-southern-california--001/view',
  createdAt: '2025-07-25T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default southernCaliforniaEdisonSce;
