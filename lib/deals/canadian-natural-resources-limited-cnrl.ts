...
/**
 * Canadian Natural Resources Limited (CNRL) - Energy & Utilities
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const canadianNaturalResourcesLimitedCnrl: Deal = {
  id: 'deal-canadian-natural-res-001',
  company: 'Canadian Natural Resources Limited (CNRL)',
  dealSizeMRR: 5850,
  dealSizeAnnual: 70200,
  industry: 'Energy',
  geography: 'Canada',
  ae: 'Andrew Kendall',
  se: 'Sarah Johnson',
  ...
  activityLog: [
    {
      id: 'activity-canadian-natura-001',
      date: '2025-10-25',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-canadian-natural-res-001/view',
  createdAt: '2025-05-10T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default canadianNaturalResourcesLimitedCnrl;
