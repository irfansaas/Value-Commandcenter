...
/**
 * Orange España - Telecommunications
 * DUMMY DATA - Replace with actual deal information when available
 * Status: HEALTHY
 */

const orangeEspaña: Deal = {
  id: 'deal-orange-españa-001',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-orange-españa-001/view',
  createdAt: '2025-07-05T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default orangeEspaña;
