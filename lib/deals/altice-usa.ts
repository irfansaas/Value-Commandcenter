...
/**
 * Altice USA, Inc. - Technology
 * DUMMY DATA - Replace with actual deal information when available
 * Status: STALLED
 */

const alticeUsaInc: Deal = {
  id: 'deal-altice-usa-001',
  company: 'Altice USA, Inc.',
  dealSizeMRR: 3750,
  dealSizeAnnual: 45000,
  industry: 'Technology',
  ...
  daysInStage: 91,
  targetCloseDate: '2026-01-15',
  lastActivityDate: '2025-10-21',
  userCount: 1500,
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-altice-usa-001/view',
  createdAt: '2025-03-23T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default alticeUsaInc;
