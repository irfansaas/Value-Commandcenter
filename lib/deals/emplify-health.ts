...
/**
 * Emplify Health - Healthcare
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const emplifyHealth: Deal = {
  id: 'deal-emplify-health-001',
  company: 'Emplify Health',
  dealSizeMRR: 5416,
  dealSizeAnnual: 65000,
  industry: 'Healthcare',
  ...
  activityLog: [
    {
      id: 'activity-emplify-health-001',
      date: '2025-10-20',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-emplify-health-001/view',
  createdAt: '2024-11-12T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default emplifyHealth;
