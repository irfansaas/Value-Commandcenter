...
/**
 * Ryder Systems - Transportation & Logistics
 * DUMMY DATA - Replace with actual deal information when available
 * Status: HEALTHY
 */

const ryderSystems: Deal = {
  id: 'deal-ryder-systems-001',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-ryder-systems-001/view',
  createdAt: '2025-03-20T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default ryderSystems;
