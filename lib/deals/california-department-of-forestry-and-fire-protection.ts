...
/**
 * California Department of Forestry and Fire Protection - Government
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const californiaDepartmentOfForestryAndFireProtection: Deal = {
  id: 'deal-california-departmen-001',
  company: 'California Department of Forestry and Fire Protection',
  dealSizeMRR: 5250,
  dealSizeAnnual: 63000,
  industry: 'Government',
  ...
  activityLog: [
    {
      id: 'activity-california-depa-001',
      date: '2025-10-20',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-california-departmen-001/view',
  createdAt: '2025-02-01T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default californiaDepartmentOfForestryAndFireProtection;
