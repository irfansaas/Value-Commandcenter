...
/**
 * Canada Union of Public Employees - Government
 * DUMMY DATA - Replace with actual deal information when available
 * Status: HEALTHY
 */

const canadaUnionOfPublicEmployees: Deal = {
  id: 'deal-canada-union-of-publ-001',
  company: 'Canada Union of Public Employees',
  dealSizeMRR: 4000,
  dealSizeAnnual: 48000,
  industry: 'Government',
  geography: 'Canada',
  ae: 'Andrew Kendall',
  se: 'Sarah Johnson',
  ...
  activityLog: [
    {
      id: 'activity-canada-union-of-001',
      date: '2025-10-19',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-canada-union-of-publ-001/view',
  createdAt: '2025-04-14T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default canadaUnionOfPublicEmployees;
