...
/**
 * ATI Restoration, LLC - Professional Services
 * DUMMY DATA - Replace with actual deal information when available
 * Status: HEALTHY
 */

const atiRestorationLlc: Deal = {
  id: 'deal-ati-restoration-001',
  company: 'ATI Restoration, LLC',
  dealSizeMRR: 2300,
  dealSizeAnnual: 27600,
  industry: 'Other',
  ...
  activityLog: [
    {
      id: 'activity-ati-restoration-001',
      date: '2025-10-17',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-ati-restoration-001/view',
  createdAt: '2025-04-10T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default atiRestorationLlc;
