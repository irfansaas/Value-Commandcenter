...
const btBritishTelecom: Deal = {
  id: 'deal-bt---british-telecom-001',
  company: 'BT - British Telecom',
  dealSizeMRR: 7916,
  dealSizeAnnual: 95000,
  industry: 'Telecom',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-bt---british-telecom-001/view',
  createdAt: '2025-02-23T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default btBritishTelecom;
