...
const natwestBank: Deal = {
  id: 'deal-natwest-bank-001',
  company: 'NatWest Bank',
  dealSizeMRR: 6666,
  dealSizeAnnual: 80000,
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-natwest-bank-001/view',
  createdAt: '2025-03-14T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default natwestBank;
