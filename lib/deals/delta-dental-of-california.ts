...
/**
 * Delta Dental of California - Healthcare
 * DUMMY DATA - Replace with actual deal information when available
 * Status: HEALTHY
 */

const deltaDentalOfCalifornia: Deal = {
  id: 'deal-delta-dental-of-cali-001',
  ...
  activityLog: [
    {
      id: 'activity-delta-dental-of-001',
      date: '2025-10-23',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-delta-dental-of-cali-001/view',
  createdAt: '2024-12-04T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default deltaDentalOfCalifornia;
