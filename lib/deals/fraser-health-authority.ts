...
/**
 * Fraser Health Authority - Healthcare
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const fraserHealthAuthority: Deal = {
  id: 'deal-fraser-health-author-001',
  company: 'Fraser Health Authority',
  dealSizeMRR: 3250,
  dealSizeAnnual: 39000,
  industry: 'Healthcare',
  geography: 'Canada',
  ae: 'Andrew Kendall',
  se: 'Sarah Johnson',
  ...
  activityLog: [
    {
      id: 'activity-fraser-health-a-001',
      date: '2025-10-27',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-fraser-health-author-001/view',
  createdAt: '2025-01-09T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default fraserHealthAuthority;
