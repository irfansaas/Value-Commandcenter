...
/**
 * CA Dept of Transportation - Technology
 * DUMMY DATA - Replace with actual deal information when available
 * Status: AT-RISK
 */

const caDeptOfTransportation: Deal = {
  id: 'deal-ca-dept-of-transport-001',
  company: 'CA Dept of Transportation',
  dealSizeMRR: 2833,
  dealSizeAnnual: 34000,
  industry: 'Technology',
  ...
  activityLog: [
    {
      id: 'activity-ca-dept-of-tran-001',
      date: '2025-10-17',
      type: 'call',
  ...
  salesforceUrl: 'https://nerdio.lightning.force.com/lightning/r/Opportunity/deal-ca-dept-of-transport-001/view',
  createdAt: '2025-06-25T05:12:42Z',
  updatedAt: '2025-10-30T05:12:42Z',
  createdBy: 'Mohammed',
  lastUpdatedBy: 'System (Generated)',
};

export default caDeptOfTransportation;
