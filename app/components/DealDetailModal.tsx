...
export function DealDetailModal({ deal, onClose }: DealDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div
        className="bg-white rounded-xl shadow-xl border border-gray-200 max-w-4xl w-full max-h-[90vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-nerdio-primary to-blue-700 text-white px-6 py-4 flex items-center justify-between rounded-t-xl">
        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 hover:bg-nerdio-light/20 transition-colors duration-200">
