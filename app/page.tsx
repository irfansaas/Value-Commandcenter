...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <header className="header-gradient border-b border-nerdio-primary sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white">🎯 Nerdio VE Command Center</h1>
              <p className="text-white/90 mt-1">Strategic Deal Management & Value Engineering Platform</p>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {filteredDeals.length > 0 ? (
          <div
            className={
              viewMode === 'grid'
                ? 'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-1'
                : 'space-y-4'
            }
          >
